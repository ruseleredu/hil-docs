...
```bash
npx create-docusaurus@latest hil-docs classic --typescript
```
...
git branch -M main
git remote add origin https://github.com/ruseleredu/hil-docs.git
...
```bash
git clone https://github.com/ruseleredu/hil-docs.git
cd hil-docs
npm i
```
