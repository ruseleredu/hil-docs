...
- [TI’s Code Composer Studio (CCS)](https://www.ti.com/tool/CCSTUDIO-C2000) An Integrated Development Environment (IDE) for development of code for the C2000 family of devices
- [C2000Ware Software Development Kit (SDK)](https://www.ti.com/tool/C2000WARE) An SDK including low level drivers, highly optimized libraries, and software examples to start using the C2000 family of devices.
